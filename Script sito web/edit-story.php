...
if($_SERVER["REQUEST_METHOD"] == "POST") {
	...
	if(!$conn->exec($myCreateStatement)) {
    			...
    			foreach ($_POST['paragraph'] as $textArea) {
					...
					$my_Insert_Statement = $conn->prepare("INSERT INTO `$titleTemp` (Testo, Immagine, nome, tipo, Colore) VALUES (:paragraph, :dati_file, :nome_file_vero, :tipo_file, :color)");
...
<html lang="it">
    ...
    <body onload="access_story_to_edit();">
		<!--navigationBar-->   
        <div class="topPage">
            <!--navigationBar-->   
            ...
            <input type="text" name="story_title" id="story_title" style="display: none;">
           	<div class="top-banner">
                  ...
                  <div class="top-banner-left-side">
                      <h2 id="title_text" name="title_text"></h2>
              ...
              <div class="two-column-layout">
                <div id="container" class="paragraph-card">
                  <div id="paragraph1" class="paragraph">
                      ...
                      <div id="imageSelector1" class="itemSel">
                          ...
                          <div id='image-link1' style='display:none;'></div>
                ...
                <div id="help-panel" class="right-column">
                    ...
                    <div id="btn-container2" class="button-container">
                  		<input id="moral-button1" type="button" onclick="createMoral()" value="+">
                  		<input id="moral-button2" type="button" onclick="deleteMoral()" value="-">
					</div>
